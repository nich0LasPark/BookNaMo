// Handles user registration logic, including creating a new user and sending an OTP for email verification.
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Email not confirmed yet - will be confirmed after OTP verification
